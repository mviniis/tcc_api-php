...
use App\Rules\{CnpjRule, CpfRule, EmailRule};
	...
	public function rules(): array {
		...
		if(!is_numeric($idUsuario)) {
			throw new ApiValidationException(
				"Para atualizar um cuidador, deve-se informar um ID válido!", code: 422
			);
		}
		...
		if(!is_numeric($obUsuario->id)) {
			throw new ApiValidationException(
				"O cuidador informado não foi encontrado!", code: 404
			);
		}
